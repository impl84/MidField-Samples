	...
	extends		JFrame
{
	...
	private static final String
		STR_PROGRAM_NAME	= Messages.getString("RemoteController.0"),	//$NON-NLS-1$
		STR_TITLE_FORMAT	= STR_PROGRAM_NAME + " (%s)";				//$NON-NLS-1$
	
	private static final String
		STR_CANT_CONNECT	= Messages.getString("RemoteController.1");	//$NON-NLS-1$
	
	public static final String
		LINE_SEPARATOR		= Messages.getString("RemoteController.3"),	 //$NON-NLS-1$
		LINE_HEADER			= Messages.getString("RemoteController.4");	 //$NON-NLS-1$

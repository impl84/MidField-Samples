        ...
        ConsoleMenu
{
    ...
    private static final String TRANSITION_TO_INPUT = "ストリーム入出力設定 → □入力設定";
    private static final String SHOW_STREAM_LIST    = "ストリーム一覧表示";
    private static final String SELECT_STREAM       = "ストリーム選択       → □ストリーム操作";
    private static final String EXIT                = "終了";

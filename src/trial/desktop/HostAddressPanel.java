...
/*----------------------------------------------------------------------------*/
/**
 * Sample code for MidField API: HostAddressPanel
 *
        ...
        InputMethodListener
{
    ...
    public static final String STR_START_CONTROL = "開始";
    public static final String STR_STOP_CONTROL  = "停止";
    
    public static final String STR_PLEASE_INPUT = "ホスト名 / IPアドレスを入力してください．";
    public static final String STR_INVALID_ADDR = "%s への接続に失敗しました．";
    
    // - PRIVATE CONSTANT VALUE ------------------------------------------------
    private static final String STR_REMOTE_HOST = "  ホスト名/IPアドレス : ";

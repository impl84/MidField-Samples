...
/*----------------------------------------------------------------------------*/
/**
 * Sample code for MidField API: RemoteDesktop
 *
        ...
        ActionListener
{
    ...
    private static final String STR_FRAME_TITLE = "遠隔デスクトップ操作";
    
    private static final String STR_ACCEPTANCE  = "遠隔操作を受け入れる";
    private static final String STR_NEW_REMOCON = "新しい遠隔操作用ウィンドウを生成する";
    
    private static final String STR_OPEN_SERVER  = "遠隔操作の受け入れを開始します．";
    private static final String STR_CLOSE_SERVER = "遠隔操作の受け入れを終了します．";
    
    private static final String STR_ALREADY_IN_USE = "既に遠隔操作受け入れ処理中です．";
    private static final String STR_NOT_RUNNING    = "遠隔操作受け入れ処理は行われていません．";
...
// -----------------------------------------------------------------------------
    ...
    public void actionPerformed(ActionEvent ev)
    {
        ...
        switch (actCmd) {
        case STR_ACCEPTANCE:
            evHn_Acceptance((JToggleButton)obj);
            break;
        case STR_NEW_REMOCON:
            evHn_Control();
            break;
        default:
            break;

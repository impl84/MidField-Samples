        ...
        InputMethodListener
{
    ...
    private static final String STR_START_CONTROL = Messages.getString("ServerAddressPanel.0"); //$NON-NLS-1$
    private static final String STR_STOP_CONTROL  = Messages.getString("ServerAddressPanel.1"); //$NON-NLS-1$
    private static final String STR_PLEASE_INPUT  = Messages.getString("ServerAddressPanel.2"); //$NON-NLS-1$
    private static final String STR_INVALID_ADDR  = Messages.getString("ServerAddressPanel.3"); //$NON-NLS-1$
    private static final String STR_REMOTE_HOST   = Messages.getString("ServerAddressPanel.4"); //$NON-NLS-1$

...
import static com.midfield_system.ui.misc.GuiConstants.BDR_EMPTY_8;
...
import rpc.remocon.ServerAddressPanel.ConnectionState;
    ...
    private void openRpcClient(String address)
    {
        ...
        try {
            ...
            this.rpcClient = new RpcClient(
                ...
                HANDLER		// InternalErrorListener のインスタンス

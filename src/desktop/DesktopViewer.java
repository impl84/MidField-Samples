...
import static desktop.DesktopMessage.Action.KEY_PRESS;
import static desktop.DesktopMessage.Action.KEY_RELEASE;
import static desktop.DesktopMessage.Action.MOUSE_MOVE;
import static desktop.DesktopMessage.Action.MOUSE_PRESS;
import static desktop.DesktopMessage.Action.MOUSE_RELEASE;
import static desktop.DesktopMessage.Action.MOUSE_WHEEL;
				...
				ActionListener
{
	...
	private static final Dimension
		DIM_FRAME = new Dimension(FRAME_WIDTH, FRAME_HEIGHT),
		DIM_MIN = new Dimension(FRAME_WIDTH / 2, FRAME_HEIGHT / 2);
